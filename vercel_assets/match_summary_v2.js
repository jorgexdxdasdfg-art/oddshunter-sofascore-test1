...
summaryIcon = function(kind){
  if(kind==="ball"||kind==="ball-premium"){
    const id=kind==="ball-premium"?"ohBallPremiumV7":"ohBallV7";
    return `<svg viewBox="0 0 32 32" aria-hidden="true"><defs><filter id="${id}Shadow" x="-25%" y="-25%" width="150%" height="165%"><feDropShadow dx="0" dy="1.35" stdDeviation="1.05" flood-color="#111827" flood-opacity=".38"/></filter><radialGradient id="${id}White" cx="31%" cy="23%" r="78%"><stop stop-color="#fff"/><stop offset=".5" stop-color="#f6f7f8"/><stop offset=".82" stop-color="#cfd2d6"/><stop offset="1" stop-color="#858a91"/></radialGradient><linearGradient id="${id}Black" x1="0" y1="0" x2="1" y2="1"><stop stop-color="#43474d"/><stop offset=".55" stop-color="#111214"/><stop offset="1" stop-color="#000"/></linearGradient></defs><g filter="url(#${id}Shadow)"><circle cx="16" cy="15.4" r="11.7" fill="url(#${id}White)" stroke="#777c83" stroke-width=".6"/><path d="m16 10.15 4.15 3.02-1.58 4.87h-5.14l-1.58-4.87Z" fill="url(#${id}Black)"/><path d="M10.1 5.35 13.6 4l2.4 2.2-2.15 4.1-4.55.25-1.5-2.35ZM21.9 5.35 18.4 4 16 6.2l2.15 4.1 4.55.25 1.5-2.35ZM4.5 14.6l2.65-3.65 2.15-.4 2.55 2.62-1.35 4.65-4.3 1.2-1.65-1.8ZM27.5 14.6l-2.65-3.65-2.15-.4-2.55 2.62 1.35 4.65 4.3 1.2 1.65-1.8ZM10.7 26l-3.2-3.2-1.3-3.78 4.3-1.2 3.55 3.05-1.15 4.35ZM21.3 26l3.2-3.2 1.3-3.78-4.3-1.2-3.55 3.05 1.15 4.35Z" fill="url(#${id}Black)"/><path d="m13.85 10.3-2 2.87m6.3-2.87 2 2.87m-8.3 4.65 2.2 3.05m6.1-3.05-2.2 3.05" fill="none" stroke="#555a61" stroke-width=".75"/><path d="M8.3 8.1a10.7 10.7 0 0 1 6.15-3.25" fill="none" stroke="#fff" stroke-width="1.1" stroke-linecap="round" stroke-opacity=".8"/></g></svg>`;
  }
