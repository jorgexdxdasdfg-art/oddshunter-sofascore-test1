...
def build(args: argparse.Namespace) -> dict[str, Any]:
    ...
    provider_blocked_backfill = (
        ...
        },
        {
            "event_id": 16483673,
            "league_id": 3283,
            "competition_name": "Trendyol Süper Lig",
    ...
    for fallback in provider_blocked_backfill:
        ...
        db_rows.append({
            ...
            "competition_name": fallback.get("competition_name") or competition.get("name") or competition.get("key"),
            "home_team_id": fallback.get("home_team_id"),
            "home_team": fallback["home_team"],
            "away_team_id": fallback.get("away_team_id"),
